                            ...
                            <TableRow>
                                ...
                                <TableHead>
                                    <Button
                                        variant="ghost"
                                        className="group inline-flex"
                                        onClick={() => onSortable('rent_start_date')}
                                    >
                                        Tanggal Peminjaman
                                        <span className="ml-2 flex-none rounded text-muted-foreground">
                                            <IconArrowsDownUp className="size-4 text-muted-foreground" />
                                ...
                                <TableHead>
                                    <Button
                                        variant="ghost"
                                        className="group inline-flex"
                                        onClick={() => onSortable('rent_end_date')}
                                    >
                                        Batas Pengembalian
                                        <span className="ml-2 flex-none rounded text-muted-foreground">
                                            <IconArrowsDownUp className="size-4 text-muted-foreground" />
                        ...
                        <TableBody>
                            {return_products.map((return_product, index) => (
                                <TableRow key={index}>
                                    ...
                                    <TableCell>{return_product.loan.rent_start_date}</TableCell>
                                    <TableCell>{return_product.loan.rent_end_date}</TableCell>
