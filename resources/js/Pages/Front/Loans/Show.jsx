                ...
                <CardContent className="divide-y divide-gray-200 py-6">
                    <div className="flex items-center lg:items-start">
                        ...
                        <div className="ml-6 flex-1 text-sm">
                            ...
                            <p className="hidden text-muted-foreground lg:mt-2 lg:block">{props.loan.product.description}</p>
                        </div>
                    </div>
                </CardContent>
                <CardFooter className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                    <div className="flex items-center">
                        ...
                        <p className="ml-2 text-sm font-medium text-muted-foreground">
                            Kembalikan sebelum tanggal <time dateTime={props.loan.rent_end_date}>{props.loan.rent_end_date}</time>
                        </p>
                    </div>
